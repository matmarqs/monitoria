...
def main():
    ...
    plt.plot(ks, wk(ks, 0.20), label=r'$h/J = 0.20$')
    plt.plot(ks, wk(ks, 0.50), label=r'$h/J = 0.50$')
    plt.plot(ks, wk(ks, 1.00), label=r'$h/J = 1.00$')
    plt.plot(ks, wk(ks, 1.25), label=r'$h/J = 1.25$')
    plt.plot(ks, wk(ks, 1.50), label=r'$h/J = 1.50$')
    plt.xlabel(r'$k$', fontsize=20)
    plt.ylabel(r'$\omega(k)$', fontsize=20)
